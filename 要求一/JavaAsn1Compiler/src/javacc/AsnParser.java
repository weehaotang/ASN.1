...
//package au.com.forge.osi.arc;

import java.io.*;
import java.util.*;

/*
 * NOTE : If syntax errors exist in this java class, do not care them and run the project!
 */
        ...
        lookForAssignment(Node n)
        {
			 ...
			 */
                        if(node instanceof ASTTypeAssignment)
                        {
                                ...
                                Token ltoken = left.first_token; // this will hold the class name
                                /*
				 * the next tree node will have the type - either a built in type
				 * or a user defined type - this is what the class will extend
				 */
                                Token rtoken = right.first_token;

                                if(right instanceof ASTBuiltinType)
                                {
                                        System.out.println(left.first_token + " ::= " + ((ASTBuiltinType)right).getType());
                                        ((ASTBuiltinType)right).createClass(left.first_token.image);
                                }
                                else if(right instanceof ASTDefinedType)
                                {
                                        System.out.println(left.first_token + " ::= " + ((ASTDefinedType)right).getType());
                                        ((ASTDefinedType)right).createClass(left.first_token.image);
                                }
                                else
                                        System.out.println(left.first_token + " ::= " + right.first_token);
                        }
                        else
...
try {Token tok;
  ...
  static final public void GlobalType() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
...
try {Token tok;
  ...
  static final private int[] jj_la1_1 = {0x0,0x100040,0x100040,0x0,0x800000,0x1000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x26001ae,0x0,0x0,0x26001ae,0x0,0x0,0x0,0x0,0x0,0x0,0x28,0x0,0x0,0x20000000,0x28,0x26009ae,0x0,0x600,0x600,0x26009ae,0x100040,0x100040,0x7000,0x0,0x7000,0x0,0x0,0xec018004,0x8018004,0x0,0x0,0x10018004,0x0,0x800,0x0,0x0,0x0,0x0,0x200,0x200,0x0,0x18004,0x0,0x0,0x18004,0x0,0x18000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x18004,0x0,0x0,0x0,};
  static final private int[] jj_la1_2 = {0x80000,0x0,0x0,0x0,0x0,0x0,0xd0080,0xd0080,0x0,0xd0080,0xd0080,0x0,0xd0080,0x0,0xd0080,0x0,0xc0000,0x90080,0x90080,0xd0080,0x80000,0x0,0x40000,0x0,0x0,0x0,0xc0000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc0000,0x0,0x0,0x0,0xc0000,0x0,0x0,0x0,0xc0000,0x0,0x8,0x0,0xc0060,0xc0060,0x0,0x0,0xc0060,0x0,0x1,0x0,0x0,0x40000,0x0,0x6,0x6,0x0,0x60,0xc0000,0x80000,0x60,0x40000,0x0,0x60,0x40000,0x40000,0xc0000,0x0,0x0,0x10080,0x10080,0x800,0x1000,0x2000,0x4000,0x0,0xc0060,0x8000,0x800,0x1000,};
